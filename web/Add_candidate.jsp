...
<html lang="en">
    ...
    <%
        if (request.getParameter("Candidate_added") != null) {%>
    <script>alert('Candidate Added');</script>  
    <%}
    %>
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="Add_candidate.jsp" class="nav-item nav-link active">Add Candidate</a>
                        <a href="View_results.jsp" class="nav-item nav-link">View Results</a>
                        <a href="View_voters.jsp" class="nav-item nav-link">View Voters</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Add Candidate</span></h1>
            </div>
            <center><div class="row gx-0 align-items-center">
                <div class="col-lg-6">
                        <div class="contact-form bg-light p-5">
                            <form action="add_candidate" method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                    <center>
                                        <div class="col-7">
                                        ...
                                        <div class="col-7">
                                            ...
                                            <input type="text" required=""  name="candidate_name" class="form-control border-primary" style="height: 55px;">
                                        </div>
                                        <br> 
                                        <div class="col-7">
                                            <label>Party Name:</label>
                                            <input type="text" required=""  name="party_name" class="form-control border-primary" style="height: 55px;">
                                        </div>
                                        <br> 
                                        <div class="col-7">
                                            <label>Address:</label>
                                            <input type="text" required=""  name="address" class="form-control border-primary" style="height: 55px;">
                                        </div>
                                        <br> 
                                        <div class="col-7">
                                            <label>Phone No:</label>
                                            <input type="text" required=""  name="phone" class="form-control border-primary" style="height: 55px;">
                                        </div>
                                        <br> 
                                        <div class="col-7">
                                            <label>Photo:</label>
                                            <input type="file" required="" name="photo" accept="image/x-png,image/gif,image/jpeg" onchange="loadFile(event)" class="form-control border-primary" style="height: 55px;">
                                        </div>
                                        <br> 
                                        <br>
                                        <div class="col-5">
                            ...
                            <div class="col-md-5" style="float: right;margin-bottom: 400px">
