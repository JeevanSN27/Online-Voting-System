            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="Add_election.jsp" class="nav-item nav-link active">Add Election</a>
 ...
 <!-- Page Header Start -->
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Candidate Profile</span></h1>
        </div>
                                    ...
                                    <center>
                                        ...
                                        <form method="post" action="">
                                           <div class="col-7">
                                                ...
                                                <input type="text" readonly="" value="<%=rs.getString("candidate_name")%>" class="form-control border-primary">
                                            </div>
                                            <br>
                                           <div class="col-7">
                                                <label>Party Name :</label>
                                                <input type="text" readonly="" value="<%=rs.getString("party_name")%>"  class="form-control border-primary">
                                            </div>
                                              <br>
                                           <div class="col-7">
                                                <label>Phone No :</label>
                                                <input type="text" readonly="" value="<%=rs.getString("phone")%>"   class="form-control border-primary">
                                            </div>
                                              <br>
                                            <div class="col-7">
                                                <label>Address :</label>
                                                <input type="text" readonly="" value="<%=address%>"   class="form-control border-primary">
                                            </div>
                                        </form> </center>
                                    <%
                                            }
