 ...
 <!-- Page Header Start -->
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Add Election</span></h1>
        </div>
        <div class="row gx-0 align-items-center">
            <center><div class="col-lg-6">
                <div class="contact-form bg-light p-5">
                       <form action="add_election" method="post">
                    <div class="row g-3">
                        <center><div class="col-7">
                                <label>Election Name</label>
                                <input type="text" required=""  name="election_name" class="form-control border-primary" style="height: 55px;">
                        </div>
                            <br> 
                        <div class="col-7">
                             <label>End Date:</label>
                            <input type="date" required=""  name="end_date" class="form-control border-primary" style="height: 55px;">
                        </div>
                        <br> <br>
                        <div class="col-5">
