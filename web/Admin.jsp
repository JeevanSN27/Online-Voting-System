        ...
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="Admin.jsp" class="nav-item nav-link active">Admin</a>
 ...
 <!-- Page Header Start -->
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Admin Login</span></h1>
        </div>
                ...
                <div class="contact-form bg-light p-5">
                    ...
                    <div class="row g-3">
                        <center><div class="col-7">
                                <input type="text" required=""  name="name" class="form-control border-primary" placeholder="Name" style="height: 55px;">
                        </div>
                            <br> 
                        <div class="col-7">
                            <input type="password" required=""  name="pass" class="form-control border-primary" placeholder="Password" style="height: 55px;">
                        </div>
                        <br> <br>
                        <div class="col-5">
