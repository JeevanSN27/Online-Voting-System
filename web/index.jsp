        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/pexels-edmond-dantès-7103098.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-4 text-uppercase text-white mb-md-4">Online Voting System</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Voting System </a>
                        </div>
                    </div>
                </div>
            </div>
