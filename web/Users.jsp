 ...
 <!-- Page Header Start -->
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">User Login</span></h1>
        </div>
                ...
                <div class="contact-form bg-light p-5">
                    ...
                    <div class="row g-3">
                        <center><div class="col-7">
                                <input type="email" required=""  name="email" class="form-control border-primary" placeholder="Email" style="height: 55px; border: 2px solid #FDBE33;" autocomplete="off">
                        </div>
                            <br> 
                        <div class="col-7">
                            <input type="password" required=""  name="pass" class="form-control border-primary" placeholder="Password" style="height: 55px;border: 2px solid #FDBE33;" autocomplete="new-password">
                        </div>
                        <br> <br>
                        <div class="col-5">
                    ...
                    <br>  <br>  <br>
                    <a href="UserReg.jsp" >Click here for <span><strong style="color: #98380c">New Registration</strong></span></a>
                </div>
                </div></center>
        </div>
    </div>
